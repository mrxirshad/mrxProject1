...
import 'package:mrxproject/newe_entry/IconsData.dart';
import 'package:rxdart/rxdart.dart';

import 'errors.dart';
class NewEntryBlock{
  BehaviorSubject<IconsData>? _selectedIconsData$;
  ValueStream<IconsData>? get selectedIconsData =>
      _selectedIconsData$!.stream;
  ...
  NewEntryBlock(){
    ...
    _selectedTimeOfDay$ = BehaviorSubject<String>.seeded("none") as BehaviorSubject<int>?;
