...
import 'package:mrxproject/newe_entry/Settings_Details.dart';
             ...
             child: Column(
               children: [
                 ...
                 SettingsDetails(
                   ...
                   iconsBack: CupertinoIcons.chevron_forward,
                   iPressed: (){
                     Navigator.push(context, MaterialPageRoute(builder: (context)=>CalendarApp(),));
                   },
                 ),
                 const SizedBox(height: 10,),
                 SettingsDetails(
...
class SettingsDetails extends StatelessWidget {
   const SettingsDetails({super.key, required this.icons, required this.name, required this.iconsBack,required this.iPressed});
